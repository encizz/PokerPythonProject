...
def main():
    ...
    class GamePage(Frame):
        ...
        def update(self, game):
            ...
            try:
                card1 = ImageTk.PhotoImage(
                    Image.open("cards\\" + str(game.list_of_players[0].cards[0]) + ".png").resize((55, 85),
                                                                                                  Image.ANTIALIAS))
                self.card1_p0.image = card1
                self.card1_p0.configure(image=card1)

                card1 = ImageTk.PhotoImage(
                    Image.open("cards\\" + str(game.list_of_players[1].cards[0]) + ".png").resize((55, 85),
                                                                                                  Image.ANTIALIAS))
                self.card1_p1.image = card1
                self.card1_p1.configure(image=card1)

                card1 = ImageTk.PhotoImage(
                    Image.open("cards\\" + str(game.list_of_players[2].cards[0]) + ".png").resize((55, 85),
                                                                                                  Image.ANTIALIAS))
                self.card1_p2.image = card1
                self.card1_p2.configure(image=card1)

                card1 = ImageTk.PhotoImage(
                    Image.open("cards\\" + str(game.list_of_players[3].cards[0]) + ".png").resize((55, 85),
                                                                                                  Image.ANTIALIAS))
                self.card1_p3.image = card1
                self.card1_p3.configure(image=card1)

                card1 = ImageTk.PhotoImage(
                    Image.open("cards\\" + str(game.list_of_players[4].cards[0]) + ".png").resize((55, 85),
                                                                                                  Image.ANTIALIAS))
                self.card1_p4.image = card1
                self.card1_p4.configure(image=card1)

                card1 = ImageTk.PhotoImage(
                    Image.open("cards\\" + str(game.list_of_players[5].cards[0]) + ".png").resize((55, 85),
                                                                                                  Image.ANTIALIAS))
                self.card1_p5.image = card1
                self.card1_p5.configure(image=card1)

                card1 = ImageTk.PhotoImage(
                    Image.open("cards\\" + str(game.list_of_players[6].cards[0]) + ".png").resize((55, 85),
                                                                                                  Image.ANTIALIAS))
                self.card1_p6.image = card1
                self.card1_p6.configure(image=card1)

                card1 = ImageTk.PhotoImage(
                    Image.open("cards\\" + str(game.list_of_players[7].cards[0]) + ".png").resize((55, 85),
                                                                                                  Image.ANTIALIAS))
                self.card1_p7.image = card1
                self.card1_p7.configure(image=card1)

                card1 = ImageTk.PhotoImage(
                    Image.open("cards\\" + str(game.list_of_players[8].cards[0]) + ".png").resize((55, 85),
                                                                                                  Image.ANTIALIAS))
                self.card1_p8.image = card1
                self.card1_p8.configure(image=card1)

                card1 = ImageTk.PhotoImage(
                    Image.open("cards\\" + str(game.list_of_players[9].cards[0]) + ".png").resize((55, 85),
                                                                                                  Image.ANTIALIAS))
            ...
            try:
                card2 = ImageTk.PhotoImage(
                    Image.open("cards\\" + str(game.list_of_players[0].cards[1]) + ".png").resize((55, 85),
                                                                                                  Image.ANTIALIAS))
                self.card2_p0.image = card2
                self.card2_p0.configure(image=card2)

                card2 = ImageTk.PhotoImage(
                    Image.open("cards\\" + str(game.list_of_players[1].cards[1]) + ".png").resize((55, 85),
                                                                                                  Image.ANTIALIAS))
                self.card2_p1.image = card2
                self.card2_p1.configure(image=card2)

                card2 = ImageTk.PhotoImage(
                    Image.open("cards\\" + str(game.list_of_players[2].cards[1]) + ".png").resize((55, 85),
                                                                                                  Image.ANTIALIAS))
                self.card2_p2.image = card2
                self.card2_p2.configure(image=card2)

                card2 = ImageTk.PhotoImage(
                    Image.open("cards\\" + str(game.list_of_players[3].cards[1]) + ".png").resize((55, 85),
                                                                                                  Image.ANTIALIAS))
                self.card2_p3.image = card2
                self.card2_p3.configure(image=card2)

                card2 = ImageTk.PhotoImage(
                    Image.open("cards\\" + str(game.list_of_players[4].cards[1]) + ".png").resize((55, 85),
                                                                                                  Image.ANTIALIAS))
                self.card2_p4.image = card2
                self.card2_p4.configure(image=card2)

                card2 = ImageTk.PhotoImage(
                    Image.open("cards\\" + str(game.list_of_players[5].cards[1]) + ".png").resize((55, 85),
                                                                                                  Image.ANTIALIAS))
                self.card2_p5.image = card2
                self.card2_p5.configure(image=card2)

                card2 = ImageTk.PhotoImage(
                    Image.open("cards\\" + str(game.list_of_players[6].cards[1]) + ".png").resize((55, 85),
                                                                                                  Image.ANTIALIAS))
                self.card2_p6.image = card2
                self.card2_p6.configure(image=card2)

                card2 = ImageTk.PhotoImage(
                    Image.open("cards\\" + str(game.list_of_players[7].cards[1]) + ".png").resize((55, 85),
                                                                                                  Image.ANTIALIAS))
                self.card2_p7.image = card2
                self.card2_p7.configure(image=card2)

                card2 = ImageTk.PhotoImage(
                    Image.open("cards\\" + str(game.list_of_players[8].cards[1]) + ".png").resize((55, 85),
                                                                                                  Image.ANTIALIAS))
                self.card2_p8.image = card2
                self.card2_p8.configure(image=card2)

                card2 = ImageTk.PhotoImage(
                    Image.open("cards\\" + str(game.list_of_players[9].cards[1]) + ".png").resize((55, 85),
                                                                                                  Image.ANTIALIAS))
